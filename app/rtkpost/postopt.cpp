...
//---------------------------------------------------------------------------
void __fastcall TOptDialog::BtnOLFileClick(TObject *Sender)
{
...
//---------------------------------------------------------------------------
void __fastcall TOptDialog::BtnOLFileViewClick(TObject *Sender)
{
...
{
	AnsiString edit0_Text=edit[0]->Text,edit1_Text=edit[1]->Text;
